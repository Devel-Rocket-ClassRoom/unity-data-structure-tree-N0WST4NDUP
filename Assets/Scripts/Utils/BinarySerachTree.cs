...
public class BinarySerachTree<TKey, TValue> : IDictionary<TKey, TValue> where TKey : IComparable<TKey>
{
    ...
    public TreeNode<TKey, TValue> Root => root;
    ...
    public virtual IEnumerable<KeyValuePair<TKey, TValue>> InOrderTraversal() => InOrderTraversal(root);
    ...
    public virtual IEnumerable<KeyValuePair<TKey, TValue>> PreOrderTraversal() => PreOrderTraversal(root);
    ...
    public virtual IEnumerable<KeyValuePair<TKey, TValue>> PostOrderTraversal() => PostOrderTraversal(root);
    ...
    public virtual IEnumerable<KeyValuePair<TKey, TValue>> LevelOrderTraversal() => LevelOrderTraversal(root);
